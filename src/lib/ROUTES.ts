...
export type KIT_ROUTES = {
  PAGES: {
    ...
    '/admin': never;
    '/admin/links': never;
    '/admin/links/[shortId]': 'shortId';
    '/admin/posts': never;
    '/admin/posts/[slug]': 'slug';
    '/games/farkle': never;
    '/games/farkle/[playerCount]': 'playerCount';
    '/login': never;
    '/posts': never;
    '/posts/[slug]': 'slug';
    '/social': never;
  ...
  ACTIONS: {
    'logout /': never;
    'create /admin/links': never;
    'delete /admin/links': never;
    'update /admin/links/[shortId]': 'shortId';
    'delete /admin/links/[shortId]': 'shortId';
    'syncPosts /admin/posts': never;
    'delete /admin/posts': never;
    'default /admin/posts/[slug]': 'slug';
    'default /login': never;
    'default /logout': never;
  };
